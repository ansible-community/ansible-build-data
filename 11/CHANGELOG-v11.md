...
* all modules \- added ability to authenticate using <em class="title-reference">username/password</em> and <em class="title-reference">tenant\_id</em> \(for Tenant\) in the module\.
