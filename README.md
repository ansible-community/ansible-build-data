...
* In the same sub-directory, add the collection to the `collection-meta.yaml` file.
  The maintainer's GitHub user names need to be listed there. If the collection does not provide
  a changelog in `changelogs/changelog.yaml`, the URL to the actual changelog needs to be added.
